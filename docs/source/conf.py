# -*- coding: utf-8 -*-
#
# msml documentation build configuration file, created by
...
latex_documents = [
  ('index', 'msml.tex', u'msml Documentation',
   u'Stefan Suwelack, Alexander Weigl et al.', 'manual'),
]
...
man_pages = [
    ('index', 'msml', u'msml Documentation',
     [u'Alexander Weigl, Markus Stoll, Nicolai Schoch, Sebastian Schalck, Stefan Suwelack'], 1)
]
...
texinfo_documents = [
  ('index', 'msml', u'msml Documentation',
   u'Stefan Suwelack, Alexander Weigl et al.', 'msml', 'One line description of project.',
   'Miscellaneous'),
]
