...
msml_outdir= os.path.abspath("/tmp/MSMLResultsBeamConvergenceAnalysis_buildReference_Tet10/")


refFile = os.path.abspath(msmlDir+"/examples/ConvergenceAnalysis/Beam/Beam_Tet10_NElement={0:s}.vtk".format(refN))
resultRefMeshFile = os.path.abspath(msml_outdir+"/referenceDisp_Tet10_NElement={0:s}.vtu".format(refN))
