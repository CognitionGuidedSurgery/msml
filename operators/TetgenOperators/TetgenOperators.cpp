...
bool TetgenOperators::CreateVolumeMesh(vtkPolyData* inputMesh, vtkUnstructuredGrid* outputMesh, bool preserveBoundary, bool isQuadratic )
{
	...
	std::cout<<"Starting tetgen with "<<numberOfPoints<<" points and "<<numberOfFaces<<" faces\n";
...
//		  out.save_faces("barout");
		...
		std::cout<<"Mesh generated by tetgen with "<<numberOfPointsOutput<<" points and "<<numberOfCellsOutput<<" tetras \n";

		//outputMesh->Reset();
		vtkSmartPointer<vtkPoints> thePointsOutput =
		 vtkSmartPointer<vtkPoints>::New();

		vtkSmartPointer<vtkCellArray> theCellsOutput =
